...
| `repmgr.image.tag` | Repmgr image tag | `trixie-5.5.0-23` |
...
|-------------------|--------------|-----------|-----------|
| 1.1.7 *(current)* | `trixie-5.5.0-23` | 18.x | ≥ 1.21 (PDB `policy/v1`); ≥ 1.27 for the agent-mode PDB `unhealthyPodEvictionPolicy` |
| 1.0.0 – 1.1.6 | `trixie-5.5.0-16` … `-22` | 18.x | as above |
