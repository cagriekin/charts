...
func TestDecide(t *testing.T) {
	...
	cases := []struct {
		...
		// #297's unregistered-holder promote gate had eight cases here. They went with the gate
		// itself in #298's review: nothing populated RegistryRead/LocalRegistered once #294
		// deleted the repmgr mechanism, so every case asserted the behaviour of unreachable code
		// -- on inputs no observer could produce.
